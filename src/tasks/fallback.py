...
class FallbackTaskManager:
    ...
    def trigger_manual_fetch(
        ...
        try:
            ...
            logger.info(
                f"Fallback fetch completed: {len(projects)} projects, {saved_count} saved"
            )
            return task_info
    ...
    def trigger_test_task(
        self, message: str = "Fallback test task", priority: int = 1
    ) -> Dict[str, Any]:
        """
                ...
                for project_data in projects:
                    try:
                        ...
                        existing = (
                            ...
                            .filter_by(coingecko_id=project_data["coingecko_id"])
                            .first()
                        )
    ...
    def _perform_basic_health_check(self) -> Dict[str, Any]:
        ...
        health_results = {
            ...
            "components": {
                ...
                "redis": {"status": "unavailable", "details": "Redis not available"},
            },
            "fallback_mode": True,
        }
