...
class TaskManager:
    ...
    def get_all_task_statuses(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'total_scheduled': sum(len(tasks) for tasks in scheduled_tasks_info.values()),
    ...
    def get_worker_stats(self, force_refresh: bool = False) -> Dict[str, Any]:
        ...
        if (not force_refresh and 
            ...
            datetime.utcnow() - self._cache_timestamp < timedelta(minutes=1)):
    ...
    def get_queue_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for queue in CELERY_QUEUES:
                ...
                routed_tasks = [task for task, route in TASK_ROUTES.items() 
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if celery_available and redis_available and worker_stats['total_workers'] > 0:
